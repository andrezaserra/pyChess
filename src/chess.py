...
if __name__ == "__main__":
    ...
    while True:
        ...
        i = 0
        while i < 8:
            if not chess.turn and chess.board.board[0][i] is not None and chess.board.board[0][i].name == 'P':
                chess.promotion((0, i))
                break
            elif chess.turn and chess.board.board[7][i] is not None and chess.board.board[7][i].name == 'P':
                chess.promotion((7, i))
                break
            i += 1
